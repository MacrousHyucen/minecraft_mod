...
public class ArcaneWorkbenchRecipe implements Recipe<SimpleInventory> {

    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public ArcaneWorkbenchRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<ArcaneWorkbenchRecipe> {
        ...
        public ArcaneWorkbenchRecipe read(Identifier id, JsonObject json) {
            ...
            return new ArcaneWorkbenchRecipe(id, output, inputs);
        }
