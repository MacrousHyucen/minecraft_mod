...
public class ThaumcraftAxeItem extends AxeItem {

    private final String name;
    private Item item;

    public ThaumcraftAxeItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings, String name) {
