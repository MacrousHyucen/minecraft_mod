...
public class ThaumcraftSwordItem extends SwordItem {

    private final String name;
    private Item item;

    public ThaumcraftSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings, String name) {
